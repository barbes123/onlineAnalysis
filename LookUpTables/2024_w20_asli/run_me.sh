...
lut_path="$HOME/onlineAnalysis/LookUpTables/2024_w20_asli/"
lut_link="$HOME/EliadeSorting/"

#lut_file="LUT_ELIFANT_20240516_PuBeNi.dat"
lut_file="LUT_ELIFANT_20240528_beam.dat"
#lut_ta="LUT_TA_TimeCalibGaussian_RUN17_60Co.dat"
